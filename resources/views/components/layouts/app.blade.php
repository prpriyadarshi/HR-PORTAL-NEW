...
<style>
 ...
 <div class="row" style="height: auto;width:auto;background-color: #f0f0f0;">
    ...
    <div class="card" style="border-radius:0px;height: auto; width: auto; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);background:#fff;">
        ...
        <div class="card-body" style="height: auto;width:auto; ">
            ...
            <ul class="nav flex-column">
                ...
                <div class="profile-container" style="background:">
    ...
    <h6 style="color: white; width: 200px; margin-right: 60%;" id="pageTitle">Home</h6>
        ...
        <div style="margin-top: 3%; margin-left: 1%; height: 455px; overflow-y: auto;">
