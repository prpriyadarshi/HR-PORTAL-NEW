    <div class="container-fluid p-0">
        ...
        <div class="row m-0">
            ...
            <div class="col-md-6 p-5">
                ...
                <form wire:submit.prevent="empLogin" class="login-form-with-shadow" style="margin-top: 0px; border: 1px solid rgb(2, 17, 79);">
                    <div class="logo text-center mb-1" style="padding-top: 20px;">
                        <img src="{{ asset('images/hr_expert.png') }}" alt="Company Logo" width="200" height="100">
                    </div>
