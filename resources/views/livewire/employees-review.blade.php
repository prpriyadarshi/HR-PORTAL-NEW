<div>
    ...
    .btn {
      ...
      body{
        ...
        <body>
        <h5>
                <i class="fas fa-bars hideHamburger" style="font-size: 20px; margin: 0px 10px; cursor: pointer;" onclick="myReviewMenu()"></i>
            Review
            </h5>
        <div class="row m-0">
            <div class="col-md-3 displayNone" id="review-menu-popup">
            <div>
                <p>ATTENDANCE</p>
            ...
            <div class="col-md-9" id="restricted-content" style="display: none;">
                <!-- Content to be toggled -->
               <div style="text-align: center">
                    <div class="btn-group leavewf-links" role="group" aria-label="Leave Workflow">
                ...
                <div class="row m-0">
                    ...
                    <div class="col-md-6">
                        <div class="mb-4" style="margin-top: 25px;">
                            <input class="form-control" type="text" wire:model.lazy="search" placeholder="Search for Employee">
                        </div>
                    </div>
                </div>

                <div class="container">
                    <div class="container p-0" id="restrictedActiveCard" style="display: none;">
                        <div class="card" style="height: 350px; margin-top: 20px;">
                ...
                <div class="container">
                    <div class="container p-0" id="restrictedClosedCard" style="display: none;">
        ...
        <div class="accordion-button" onclick="toggleAccordion()">
            ▼
                        ...
                        <div class="m-0 mb-3 mt-3 row">
                            ...
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMT5TgvjUm4x4YpmWdvAG8dvbNzJ67RzvX7j0fbJd2znsBYuhYkAJX4jXMFedU-ueYYZI&usqp=CAU"
                                alt="Sample Image" style="height: 50px; width: 50px; margin-right: 10px">
                            <div class="details">
                                <p class="m-0">Renuka Chinthala</p>
                                <p class="id m-0">AGS-0007</p>
                            </div>
                            </div>
                            <div class="col-md-6">
                                <p class="m-0">No.of days</p>
                                <p class="id m-0">3</p>
                            </div>
                        </div>
            ...
            <div id="attendence-content" style="display: none;" class="col-md-9">
                <!-- Content to be toggled -->
            ...
            <div id="resignation-content" style="display: none;" class="col-md-9">
                <!-- Content to be toggled -->
                <div class="btn-group leavewf-links" role="group" aria-label="Leave Workflow" style="margin-left: 300px;">
            ...
            <div id="helpdesk-content" style="display: none;" class="col-md-9">
                <!-- Content to be toggled -->
                <div class="btn-group leavewf-links" role="group" aria-label="Leave Workflow" style="margin-left: 300px;">
            ...
            <div id="holiday-content" style="display: none;" class="col-md-9">
        <!-- Content to be toggled -->
        <div class="btn-group leavewf-links" role="group" aria-label="Leave Workflow" style="margin-left: 300px;">
        ...
        <div id="leavecancel-content" style="display: none;" class="col-md-9">
        <!-- Content to be toggled -->
            <div class="btn-group leavewf-links" role="group" aria-label="Leave Workflow" style="margin-left: 300px;">
    ...
    //     }
    // }
    function myReviewMenu() {
                    document.getElementById("review-menu-popup").classList.toggle("displayBlock");
                }
