<div>
    ...
    <div class="container">
        ...
        <div class="content" style=";margin-top:-30px" >
            ...
            <div class="left-menu" style="height:500px;margin-bottom:170px;width:180px">

            <div class="row">


            <p style="margin-left:20px;margin-top:10px">ATTENDANCE</p>
      <a class="links" href="/attendance" style="margin-top: 5px; padding-left: 40px; font-size: 14px; font-family: Open Sans, sans-serif; color: black; text-decoration: none;">
    ...
    <p style="margin-left:20px;margin-top:10px">EMPINFO</p>
    <a class="links" href="/attendance" style="margin-top: 5px; padding-left: 40px; font-size: 14px; font-family: Open Sans, sans-serif; color: black; text-decoration: none;">
      <span onmouseover="this.style.color='#33B3BC'; this.style.textDecoration='underline';" onmouseout="this.style.color='black'; this.style.textDecoration='none';">
      Confirmation
      </span>
    </a>
    <a class="links" href="/attendance" style="margin-top: 20px; padding-left: 40px; font-size: 14px; font-family: Open Sans, sans-serif; color: black; text-decoration: none;">
      <span onmouseover="this.style.color='#33B3BC'; this.style.textDecoration='underline';" onmouseout="this.style.color='black'; this.style.textDecoration='none';">
      Resignations
      </span>
    </a>
    ...
    <p style="margin-left:20px;margin-top:10px">LEAVE</p>

    <a class="links" href="/attendance" style=" padding-left: 40px; font-size: 14px; font-family: Open Sans, sans-serif; color: black; text-decoration: none;">
      <span onmouseover="this.style.color='#33B3BC'; this.style.textDecoration='underline';" onmouseout="this.style.color='black'; this.style.textDecoration='none';">
      Leave
      </span>
    </a>
