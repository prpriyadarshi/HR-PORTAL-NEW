                        ...
                        <div class="reviews">
                            <div style="border-radius: 5px; border: 1px solid #CFCACA;  background-color: white;">
                                ...
                                <div class="leave-display">
                                    ...
                                    @for ($i = 0; $i < min($count, 4); $i++) <div class="circle-notify" style="margin-right: 5px; display:flex; flex-direction:column;">
                    ...
                    <div>
                        <div class="who-is-in">
                            ...
                            <div class="team-leave">
                                ...
                                @endphp
                                @for ($i = 0; $i < min($CountAbsentEmployees, 4); $i++) @if(isset($AbsentEmployees[$i])) @php $employee=$AbsentEmployees[$i]; $randomColorAbsent='#' . str_pad(dechex(mt_rand(0, 0xFFFFFF)), 6, '0' , STR_PAD_LEFT); @endphp <div class="circle" style="border: 2px solid {{getRandomAbsentColor() }};border-radius:50%;">
                                    <span class="initials">
