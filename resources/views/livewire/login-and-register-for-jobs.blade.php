        ...
        <div class="col-md-6" style="padding: 10px 40px">
            ...
            font-family: Montserrat;
                                    "
                                        ...
                                        <input wire:model="user_email" style="font-size:12px" type="email"
                                            class="form-control">
                                        @error('user_email')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label style="font-size:12px; font-family: Montserrat;"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label style="font-size:12px; font-family: Montserrat;"
                                                    for="confirmPassword">Confirm Password:</label><br>
                                                <input wire:model="user_confirm_password" style="font-size:12px"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select wire:model="user_work_status" style="font-size:12px;"
                                                    class="form-control">
            ...
            font-family: Montserrat;
                                    "
                                        ...
                                        <input wire:model="user_resume" style="font-size:12px" type="file"
                                            class="form-control">
                                    </div>
                                @endif
                                @if ($user_type == 'Vendor')
            ...
            font-family: Montserrat;
                                    "
                                        ...
                                        <input style="font-size:12px" type="file" wire:model="company_logo"
                                            accept="image/*">
                                    </div>
                                    @if ($company_logo)
                                        <div>
                                            <img style="height:90px;width:80px"
                                                src="{{ $company_logo->temporaryUrl() }}" alt="Image Preview"
            ...
            font-family: Montserrat;
                            ...
                            <button onclick="window.location.href = '{{ url('/login') }}'" class="google-login-btn"
                                        style="width:160px; margin-left: 350px;  margin-top:-50px;font-size: 12px;height:40px">
                    ...
                    @if ($activeTab == 'login')
                        ...
                        <div class="card" style="padding:10px">
                            ...
                            style="width: 165px; margin-left: 330px; margin-top:-50px; font-size: 12px;height:40px">
                            <img src="https://pbs.twimg.com/profile_images/1605297940242669568/q8-vPggS_400x400.jpg"
                                style="height: 20px; width: 20px;">
                            <div style="margin-left: 2px;">Login with Google</div>
                        </button>
                        ...
                        {{-- <div style="margin-top:10px;margin-left:15%">
                            <h6 style="font-size: 12px;"><strong style="color: red;">NOTE : </strong>Before appling
                                any job,
